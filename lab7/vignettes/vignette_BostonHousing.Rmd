...
Summary of sample sizes: 345, 342, 343, 345, 344, 344, ...   
Resampling results across tuning parameters:  

  lambda  RMSE      Rsquared   MAE       
  0.00    6.580051  0.5511862  3.290037  
  0.01    6.568754  0.5531929  3.248552  
  0.02    6.564320  0.5542507  3.226374  
  0.03    6.563836  0.5547879  3.213642  
  0.04    6.565886  0.5550105  3.207268  

RMSE was used to select the optimal model using  the smallest value.  

The final value used for the model was lambda = 0.03.  
